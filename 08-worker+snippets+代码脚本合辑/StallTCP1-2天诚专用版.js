...
/**
 * StallTCP1.2天诚专用版 
 * Cloudflare的workers和snippets部署,部署前请更换有效AUTH_UUID,默认UUID无效,部署前请删除说明。
 * 订阅地址配置：
 ...
 * 订阅器或SUB到订阅群获取，也可以使用别人的订阅器SUB，HOST就是你自定义绑定的域名
...
const AUTH_UUID = "f63a2e15-3182-4d0a-9342-b0f91656b898898";
